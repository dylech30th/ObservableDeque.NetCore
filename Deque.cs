...
{
    /// <summary>
    /// see https://github.com/dcastro/DequeNET
    /// </summary>
    ...
    public class Deque<T> : IDeque<T>
    {
        ...
        public Deque(int capacity)
        {
            ...
            buffer = capacity == 0 ? EmptyBuffer : new T[capacity];
        }
        ...
        public void Clear()
        {
            ...
            {
                //clear both halves
                Array.Clear(buffer, LeftIndex, Capacity - LeftIndex);
                Array.Clear(buffer, 0, LeftIndex + (Count - Capacity));
            }
            else //clear the whole array
                Array.Clear(buffer, LeftIndex, Count);
        ...
        void ICollection.CopyTo(Array array, int arrayIndex)
        {
            ...
            try
            {
                ...
                if (!LoopsAround)
                {
                    Array.Copy(buffer, LeftIndex, array, arrayIndex, Count);
                }
                else
                {
                    //copy both halves to a new array
                    Array.Copy(buffer, LeftIndex, array, arrayIndex, Capacity - LeftIndex);
                    Array.Copy(buffer, 0, array, arrayIndex + Capacity - LeftIndex, LeftIndex + (Count - Capacity));
                }
            }
        ...
        {
            get => buffer[VirtualIndexToBufferIndex(index)];
            set => buffer[VirtualIndexToBufferIndex(index)] = value;
        }
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            public bool MoveNext()
            {
                ...
                if (virtualIndex == deque.Count - 1)
                    return false;

                virtualIndex++;
                Current = deque[virtualIndex];
                return true;
            }
